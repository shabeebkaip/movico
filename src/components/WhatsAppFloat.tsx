...
export function WhatsAppFloat({ whatsapp }: { whatsapp: string }) {
  ...
  return (
    <motion.a
      ...
      whileTap={{ scale: 0.9 }}
      className="whatsapp-float fixed bottom-24 right-4 sm:bottom-6 sm:right-6 z-50 group"
    ...
    >
      ...
      {/* Main button */}
      <div className="relative w-12 h-12 sm:w-14 sm:h-14 bg-green-500 hover:bg-green-600 rounded-full shadow-2xl flex items-center justify-center transition-all duration-300">
        {/* WhatsApp Icon */}
        <svg
          viewBox="0 0 24 24"
          fill="white"
