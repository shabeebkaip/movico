...
export function MagneticText({
  ...
  return (
    ...
    >
      {/* Base layer — children if provided, else text */}
      {children ?? <span style={{ color: "inherit", font: "inherit", letterSpacing: "inherit", textTransform: "inherit" }}>{text}</span>}
      ...
      >
        <div
          ref={innerTextRef}
          className={cn(
            "absolute flex items-center justify-center font-display font-black uppercase",
            innerTextClassName
          )}
          style={{
